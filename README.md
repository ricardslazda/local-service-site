...
- **Conventional Commits.** An imperative lowercase subject under 72 characters, an optional body
  after a blank line, no attribution footers, no emoji. The hook enforces it.
- **No code comments.** Intent goes into names and structure, never into prose beside the code.
