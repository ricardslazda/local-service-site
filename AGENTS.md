...
under 72 characters, no trailing period. The body says why the change is made, in plain
sentences. Never add `Co-Authored-By`, `Claude-Session`, "generated with" or any other
attribution footer, and never an emoji. The commit-message hook rejects all of them.
